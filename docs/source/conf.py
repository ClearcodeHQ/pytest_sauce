...
project = u'pytest_sauce'
basename = ''.join(project.split('.'))
author = u'''Clearcode <http://clearcode.cc> and associates (see AUTHORS)'''
...
import re
with open(os.path.join(os.path.dirname(__file__), '..', '..', 'pytest_sauce', '__init__.py')) as v_file:
